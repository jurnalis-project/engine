...
fn create_wizard_state_json() -> String {
    ...
    // Ability method, Assign scores, Choose skills, Name
    for input in ["1", "Wizard", "1", "default", "2", "1", "15 14 13 12 10 8", "1 2", "Elara"] {
...
fn create_fighter_state_json() -> String {
    ...
    for input in ["1", "Fighter", "1", "default", "2", "1", "15 14 13 12 10 8", "1 2", "Conan"] {
        output = process_input(&output.state_json, input);
    }
